...
const HomeButton = () => {
    ...
    return (
        <a className='relative' href='#home'>
            <svg
                className={`fill-white fixed bottom-15 right-20 z-100 animate-bounce size-7 lg:size-10 transition duration-1000 ${visible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
