...
const Home = () => {
    return (
        ...
        <div className='h-screen relative'>
            ...
            <div class="absolute flex flex-row justify-start items-center ml-20 mt-15 z-100">

                <a href="https://www.linkedin.com/in/jamesducay" target="_blank" class="group">

                    <svg xmlns="http://www.w3.org/2000/svg" height="0.75em"
                        class="fill-white group-hover:fill-orange-600 transition duration-300 mr-3"
                        viewBox="0 0 448 512">
                        <path
                ...
                <a href="https://www.instagram.com/jdanieldcy" target="_blank" class="group">
                    <svg xmlns="http://www.w3.org/2000/svg" height="0.85em"
                        class="fill-white group-hover:fill-orange-600 transition duration-300 mx-3"
                        viewBox="0 0 448 512">
                        <path
                ...
                <a href="https://www.facebook.com/james.ducay.3" target="_blank" class="group">
                    <svg xmlns="http://www.w3.org/2000/svg" height="0.75em"
                        class="fill-white group-hover:fill-orange-600 transition duration-300 mx-3"
                        viewBox="0 0 320 512">
                        <path
